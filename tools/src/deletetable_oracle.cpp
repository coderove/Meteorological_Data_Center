...
* File name     : deletetable_oracle.cpp
* Version       : v1.0
* Author        : starrove 
* Date          : 2022/7/21 8:22.
...
{
    printf("\n----------------------------------------------------------------------------------------\n");
    printf("[Using ] :./deletetable_oracle logfilename xmlbuffer\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("[Sample] :./procctl 3600 ./deletetable_oracle /project/log/idc/deletetable_oracle_MDCMIND1.log \"<connstr>qxidc/qxidcpwd@snorcl11g_132</connstr><tname>CODE_MDCMIND1</tname><keycol>keyid</keycol><where>where ddatetime<sysdate-0.03</where><starttime>01,02,03,04,05,13</starttime><timeout>120</timeout><pname>deletetable_oracle_MDCMIND1</pname>\"\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("参数说明:\n\n");
