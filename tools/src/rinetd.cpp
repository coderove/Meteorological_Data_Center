...
* File name     : rinted.cpp
* Version       : v1.0
* Author        : starrove 
* Date          : 2022/7/22 16:35.
* Description   : 网络代理服务程序-外网端
**************************************************/
...
int main(int argc, char *argv[]) {
    if (argc != 4) {
        ...
        printf("[Sample]:./rinetd /project/log/rinetd.log /project/tool/ini/rinetd.conf 4000\n");
        printf("         ./procctl 5 ./rinetd /project/log/rinetd.log /project/tool/ini/rinetd.conf 4000\n");
