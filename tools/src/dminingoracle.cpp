...
* File name     : dminingoracle.cpp
* Version       : v1.0
* Author        : starrove 
* Date          : 2022/7/21 8:47.
* Description   : 本程序是数据中心的公共功能模块，用于从Oracle数据库源表抽取数据，生成xml文件
**************************************************/
...
void _help()
{
    ...
    printf("----------------------------------------------------------------------------------------\n");
    printf("[Sample]:./procctl 3600 ./dminingoracle /project/log/idc/dminingoracle_MDCTCODE1.log \"<connstr>qxidc/qxidcpwd@snorcl11g_132</connstr><charset>Simplified Chinese_China.AL32UTF8</charset><selectsql>select stand_id,stand_name,prov_name,lat,lon,height from CODE_MDCTCODE1</selectsql><fieldstr>stand_id,stand_name,prov_name,lat,lon,height</fieldstr><fieldlen>10,30,30,10,10,10</fieldlen><bfilename>MDCTCODE1</bfilename><efilename>HYCZ</efilename><outpath>/idcdata/dmindata1</outpath><timeout>30</timeout><pname>dminingoracle_MDCTCODE1</pname>\"\n");
    printf("         ./procctl 3600 ./dminingoracle /project/log/idc/dminingoracle_MDCTCODE1.log \"<connstr>qxidc/qxidcpwd@snorcl11g_132</connstr><charset>Simplified Chinese_China.AL32UTF8</charset><selectsql>select stand_id,to_char(ddatetime,'yyyymmddhh24miss'),t,p,u,wd,wf,r,vis,keyid from CODE_MDCMIND1 where keyid>:1 and ddatetime>sysdate-0.04</selectsql><fieldstr>stand_id,ddatetime,t,p,u,wd,wf,r,vis,keyid</fieldstr><fieldlen>10,19,8,8,8,8,8,8,8,15</fieldlen><bfilename>MDCMIND1</bfilename><efilename>HYCZ</efilename><outpath>/idcdata/dmindata1</outpath><starttime></starttime><incfield>keyid</incfield><incfilename>/idcdata/dmining/dminingoracle_MDCMIND1_HYCZ.list</incfilename><timeout>30</timeout><pname>dminingoracle_MDCMIND1_HYCZ</pname><maxcount>1000</maxcount><connstr1>qxidc/qxidcpwd@snorcl11g_132</connstr1>\"\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("参数说明:\n\n");
