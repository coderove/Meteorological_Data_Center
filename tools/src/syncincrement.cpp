...
* File name     : syncincrement.cpp
* Version       : v1.0
* Author        : starrove 
* Date          : 2022/7/20 9:50.
* Description   : 本程序是数据中心的公共功能模块，采用增量的方法同步MySQL数据库之间的表
**************************************************/
...
{
    printf("\n----------------------------------------------------------------------------------------\n");
    printf("[Using ] :./syncincrement logfilename xmlbuffer\n\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("[Sample] :./procctl 10 ./syncincrement /project/log/idc/syncincrement_MDCMIND2.log \"<localconnstr>192.168.18.133,root,123456,mdcsql,3306</localconnstr><remoteconnstr>192.168.18.133,root,123456,mdcsql,3306</remoteconnstr><charset>utf8</charset><remotetname>CODE_MDCMIND1</remotetname><fedtname>LK_MDCMIND1</fedtname><localtname>CODE_MDCMIND2</localtname><remotecols>stand_id,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</remotecols><localcols>stand_id,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</localcols><remotekeycol>keyid</remotekeycol><localkeycol>keyid</localkeycol><maxcount>300</maxcount><timetvl>2</timetvl><timeout>50</timeout><pname>syncincrement_ZHOBTMIND2</pname>\"\n");
    printf("          ./procctl 10 ./syncincrement /project/log/idc/syncincrement_MDCMIND3.log \"<localconnstr>192.168.18.133,root,123456,mdcsql,3306</localconnstr><remoteconnstr>192.168.18.133,root,123456,mdcsql,3306</remoteconnstr><charset>utf8</charset><remotetname>CODE_MDCMIND1</remotetname><fedtname>LK_MDCMIND1</fedtname><localtname>CODE_MDCMIND3</localtname><remotecols>stand_id,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</remotecols><localcols>stand_id,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</localcols><where>and stand_id like '54%%%%'</where><remotekeycol>keyid</remotekeycol><localkeycol>keyid</localkeycol><maxcount>300</maxcount><timetvl>2</timetvl><timeout>50</timeout><pname>syncincrement_MDCMIND3</pname>\"\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("参数说明:\n\n");
