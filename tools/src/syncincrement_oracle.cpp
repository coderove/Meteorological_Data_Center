...
* File name     : syncincrement_oracle.cpp
* Version       : v1.0
* Author        : starrove 
* Date          : 2022/7/21 9:26.
* Description   : 程序是数据中心的公共功能模块，采用增量的方法同步Oracle数据库之间的表
**************************************************/
...
int main(int argc,char *argv[])
{
    ...
    while (true)
    {
        ...
        if (!bcontinue) sleep(starg.timetvl);
...
{
    printf("\n----------------------------------------------------------------------------------------\n");
    printf("[Using  ]: ./syncincrement_oracle logfilename xmlbuffer\n\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("[Sample ]: ./procctl 10 ./syncincrement_oracle /project/log/idc/syncincrement_oracle_ZHOBTMIND2.log \"<localconnstr>scott/tiger@snorcl11g_130</localconnstr><remoteconnstr>qxidc/qxidcpwd@snorcl11g_132</remoteconnstr><charset>Simplified Chinese_China.AL32UTF8</charset><remotetname>CODE_MDCMIND1</remotetname><lnktname>CODE_MDCMIND1@db132</lnktname><localtname>CODE_MDCMIND2</localtname><remotecols>stand_id,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</remotecols><localcols>stand_id,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</localcols><remotekeycol>keyid</remotekeycol><localkeycol>keyid</localkeycol><maxcount>300</maxcount><timetvl>2</timetvl><timeout>50</timeout><pname>syncincrement_oracle_MDCMIND2</pname>\"\n");
    printf("           ./procctl 10 ./syncincrement_oracle /project/log/idc/syncincrement_oracle_ZHOBTMIND3.log \"<localconnstr>scott/tiger@snorcl11g_130</localconnstr><remoteconnstr>qxidc/qxidcpwd@snorcl11g_132</remoteconnstr><charset>Simplified Chinese_China.AL32UTF8</charset><remotetname>CODE_MDCMIND1</remotetname><lnktname>CODE_MDCMIND1@db132</lnktname><localtname>CODE_MDCMIND3</localtname><remotecols>stand_id,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</remotecols><localcols>stand_id,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</localcols><where>and stand_id like '54%%%%'</where><remotekeycol>keyid</remotekeycol><localkeycol>keyid</localkeycol><maxcount>300</maxcount><timetvl>2</timetvl><timeout>50</timeout><pname>syncincrement_oracle_MDCMIND3</pname>\"\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("参数说明:\n\n");
