...
* File name     : migratetable_oracle.cpp
* Version       : v1.0
* Author        : starrove 
* Date          : 2022/7/21 8:37.
...
{
    printf("\n----------------------------------------------------------------------------------------\n");
    printf("[Using ]:./migratetable_oracle logfilename xmlbuffer\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("[Sample]:./procctl 3600 ./migratetable_oracle /project/log/idc/migratetable_oracle_MDCMIND1.log \"<connstr>qxidc/qxidcpwd@snorcl11g_132</connstr><srctname>CODE_MDCMIND1</srctname><dsttname>CODE_MDCMIND_HIS</dsttname><keycol>keyid</keycol><where>where ddatetime<sysdate-0.03</where><starttime>01,02,03,04,05,13</starttime><maxcount>300</maxcount><timeout>120</timeout><pname>migratetable_oracle_MDCMIND1</pname>\"\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("参数说明:\n\n");
