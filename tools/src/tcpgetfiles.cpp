...
* File name     : tcpgetfiles.cpp
* Version       : v1.0
* Author        : starrove 
* Date          : 2022/7/16 19:31.
* Description   : TCP文件下载模块
**************************************************/
...
int main(int argc,char *argv[])
{
    ...
    // 登录业务。
    if (!Login(argv[2])) { logfile.Write("Login() failed.\n"); EXIT(-1); }
...
{
    printf("\n----------------------------------------------------------------------------------------\n");
    printf("[Using ]      :./tcpgetfiles logfilename xmlbuffer\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("[Sample]      :./procctl 20 ./tcpgetfiles /project/log/idc/tcpgetfiles_surfdata.log \"<ip>192.168.18.133</ip><port>5005</port><ptype>1</ptype><srvpath>/project/tempdata/tcp/surfdata2</srvpath><andchild>true</andchild><matchname>*.XML,*.CSV,*.JSON</matchname><clientpath>/project/tempdata/tcp/surfdata3</clientpath><timetvl>10</timetvl><timeout>50</timeout><pname>tcpgetfiles_surfdata</pname>\"\n");
    printf("               ./procctl 20 ./tcpgetfiles /project/log/idc/tcpgetfiles_surfdata.log \"<ip>192.168.18.133</ip><port>5005</port><ptype>2</ptype><srvpath>/project/tempdata/tcp/surfdata2</srvpath><srvpathbak>/project/tempdata/tcp/surfdata2bak</srvpathbak><andchild>true</andchild><matchname>*.XML,*.CSV,*.JSON</matchname><clientpath>/project/tempdata/tcp/surfdata3</clientpath><timetvl>10</timetvl><timeout>50</timeout><pname>tcpgetfiles_surfdata</pname>\"\n");
    printf("----------------------------------------------------------------------------------------\n");
    printf("参数说明:\n\n");
