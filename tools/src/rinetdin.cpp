...
* File name     : rinetdin.cpp
* Version       : v1.0
* Author        : starrove 
* Date          : 2022/7/22 16:36.
* Description   : 网络代理服务程序-内网端
**************************************************/
...
int main(int argc, char *argv[]) {
    if (argc != 4) {
        ...
        printf("[Sample]:./rinetdin /project/log/rinetdin.log 192.168.174.132 4000\n");
        printf("         ./procctl 5 ./rinetdin /project/log/rinetdin.log 192.168.174.132 4000\n");
    ...
    if (!TcpClient.ConnectToServer(argv[2], atoi(argv[3]))) {
